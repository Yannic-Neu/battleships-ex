...
public class GameScreenOpp extends ScreenAdapter {

    private final MyGame game;
    private Stage stage;

    public GameScreenOpp(MyGame game) {
        this.game = game;
    }
    ...
    public void show() {
        ...
        GameButton enemyWatersButton = new GameButton("ENEMY WATERS", tabInactiveCfg, () -> {
            System.out.println("enemy waters button pressed");
            game.setScreen(new GameScreenOwn(game));
        });

        GameButton yourFleetButton = new GameButton("YOUR FLEET", tabActiveCfg, () -> {
